...
fn built_in_provider_presets() -> Vec<ProviderPreset> {
    vec![
        ...
        provider_preset(
            "deepseek",
            "DeepSeek Official",
            "DeepSeek official OpenAI and Anthropic-compatible endpoints.",
            ...
            "codex-deepseek",
            "deepseek-chat",
            preset_policy("deepseek", None, None, None, Some(true), Some(true), Some(false), Some(true), Some(false), Some(true)),
            vec!["Claude clients should use the Anthropic endpoint; Codex keeps the OpenAI endpoint.".into()],
        ),
        provider_preset(
            "moonshot",
            "Moonshot Kimi",
        ...
        provider_preset(
            "xiaomi",
            "Xiaomi MiMo",
            "Xiaomi MiMo OpenAI and Anthropic-compatible endpoints.",
            ...
            "codex-mimo",
            "mimo-v2.5",
            preset_policy("xiaomi", None, None, None, Some(true), Some(true), Some(false), Some(true), Some(false), Some(true)),
            vec!["Claude clients should use the Anthropic endpoint; Codex keeps the OpenAI endpoint.".into()],
        ),
        provider_preset(
            "anthropic",
