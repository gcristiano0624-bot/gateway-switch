...
## 2. Version 1.8.6 Upstream Tweak Store Scope

Version 1.8.6 makes Gateway Switch a more faithful Codex++ upstream store console while keeping safe install boundaries.
